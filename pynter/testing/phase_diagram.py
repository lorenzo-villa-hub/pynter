...
class ChempotsTest(PynterTest):
    ...
    """
    def assert_Chempots_equal(self,chempots1, chempots2):
        """
        ...
        self.assert_object_almost_equal(dict1, dict2)
...
class ReservoirsTest(ChempotsTest):
    ...
    """
    def assert_Reservoirs_equal(self,reservoirs1, reservoirs2, check_reference=True):
        """
        ...
        for key in reservoirs1:
            ...
            self.assert_Chempots_equal(chempots1, chempots2)
        if check_reference:
            self.assert_Chempots_equal(reservoirs1.mu_refs, reservoirs2.mu_refs)
